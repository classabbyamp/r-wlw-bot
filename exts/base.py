...
class WlwHelpCommand(commands.HelpCommand):
    def __init__(self):
        super().__init__(command_attrs={
            "help": "Shows help about r-wlw-bot or a command",
            "aliases": ["h"],
    ...
    async def send_error_message(self, error):
        ...
        embed.title = "r-wlw-bot Help Error"
...
class BaseCog(commands.Cog):
    ...
    async def _changelog(self, ctx: commands.Context, version: str = "latest"):
        ...
        embed = cmn.embed_factory(ctx)
        embed.title = "r-wlw-bot Changelog"
        embed.description = ("For a full listing, visit [Github](https://"
                             "github.com/classabbyamp/r-wlw-bot/blob/master/CHANGELOG.md).")
    ...
    async def _issue(self, ctx: commands.Context):
        ...
        embed.description = "Submit an issue on the [issue tracker](https://github.com/classabbyamp/r-wlw-bot/issues)!"
        await ctx.send(embed=embed)
    ...
    async def _echo(self, ctx: commands.Context,
        ...
        """Sends a message in a channel as r-wlw-bot. Accepts channel/user IDs/mentions.
...
def setup(bot: commands.Bot):
    ...
    bot.help_command = WlwHelpCommand()
